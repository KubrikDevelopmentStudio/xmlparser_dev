...
function parseValidResults(data) {
    ...
    if(TAGS_COUNT_IN_XML != "" && TAGS_COUNT_IN_COMPARER_XML != "") {
            $(block_body).append("<br><br><div class='infos-msg'>Всего тегов в эталонной XML: " + TAGS_COUNT_IN_XML +
                                 "<br>Всего тегов в проверяемой XML: " + TAGS_COUNT_IN_COMPARER_XML + "</div><br>");
    }
